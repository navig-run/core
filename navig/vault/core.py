"""Compat shim -- the unified Vault API and the get_vault singleton now live in ``navig_vault.core``.
...
if TYPE_CHECKING:  # pragma: no cover - never executed; exists for static analysis only
    ...
    from navig_vault.core import *  # noqa: F401,F403

try:
    from navig_vault import core as _impl
