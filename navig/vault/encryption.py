"""Compat shim -- the master-key derivation and envelope encryption now live in ``navig_vault.encryption``.
...
if TYPE_CHECKING:  # pragma: no cover - never executed; exists for static analysis only
    ...
    from navig_vault.encryption import *  # noqa: F401,F403

try:
    from navig_vault import encryption as _impl
