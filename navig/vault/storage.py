"""Compat shim -- the credential store's SQLite layer now lives in ``navig_vault.storage``.
...
if TYPE_CHECKING:  # pragma: no cover - never executed; exists for static analysis only
    ...
    from navig_vault.storage import *  # noqa: F401,F403

try:
    from navig_vault import storage as _impl
