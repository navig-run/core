"""Compat shim -- ${VAULT:...} reference substitution now lives in ``navig_vault.resolver``.
...
if TYPE_CHECKING:  # pragma: no cover - never executed; exists for static analysis only
    ...
    from navig_vault.resolver import *  # noqa: F401,F403

try:
    from navig_vault import resolver as _impl
