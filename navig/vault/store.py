"""Compat shim -- the generic item store (VaultItem) now lives in ``navig_vault.store``.
...
if TYPE_CHECKING:  # pragma: no cover - never executed; exists for static analysis only
    ...
    from navig_vault.store import *  # noqa: F401,F403

try:
    from navig_vault import store as _impl
