"""Compat shim -- website logins and their registrable-domain binding now live in ``navig_vault.logins``.
...
if TYPE_CHECKING:  # pragma: no cover - never executed; exists for static analysis only
    ...
    from navig_vault.logins import *  # noqa: F401,F403

try:
    from navig_vault import logins as _impl
