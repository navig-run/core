"""Compat shim -- the legacy-location vault migration now lives in ``navig_vault.migrate``.
...
if TYPE_CHECKING:  # pragma: no cover - never executed; exists for static analysis only
    ...
    from navig_vault.migrate import *  # noqa: F401,F403

try:
    from navig_vault import migrate as _impl
