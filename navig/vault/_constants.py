...
aliasing itself to the implementation, rather than doing ``from navig_vault._constants import *``.
...
if TYPE_CHECKING:  # pragma: no cover - never executed; exists for static analysis only
    ...
    from navig_vault._constants import *  # noqa: F401,F403

try:
    from navig_vault import _constants as _impl
