"""Compat shim -- the per-provider credential health checks now live in ``navig_vault.validators``.
...
if TYPE_CHECKING:  # pragma: no cover - never executed; exists for static analysis only
    ...
    from navig_vault.validators import *  # noqa: F401,F403

try:
    from navig_vault import validators as _impl
