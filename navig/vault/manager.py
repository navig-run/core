"""Compat shim -- the VaultManager compatibility wrapper now lives in ``navig_vault.manager``.
...
if TYPE_CHECKING:  # pragma: no cover - never executed; exists for static analysis only
    ...
    from navig_vault.manager import *  # noqa: F401,F403

try:
    from navig_vault import manager as _impl
