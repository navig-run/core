...
def _engagement_status(gw):
    async def h(r):
        ...
        try:
            ...
            return json_error_response("Failed to get engagement status", status=500, code="internal_error", details={"error": str(e)})
    return h
...
def _engagement_tick(gw):
    async def h(r):
        ...
        try:
            ...
            return json_error_response("Failed to run engagement tick", status=500, code="internal_error", details={"error": str(e)})
    return h
