...
def _svc_or_503(gw):
    if not gw.cron_service:
        return None, json_error_response(
            "Cron service not enabled", status=503, code="module_unavailable"
        )
