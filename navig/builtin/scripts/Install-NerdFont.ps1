...
.EXAMPLE
    ...
    pwsh navig/builtin/scripts/Install-NerdFont.ps1 -NerdRelease v3.2.1
    pwsh navig/builtin/scripts/Install-NerdFont.ps1 -LocalZip C:\Downloads\JetBrainsMono.zip
#>
[CmdletBinding()]
param(
