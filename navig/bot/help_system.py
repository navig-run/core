...
def get_all_commands() -> Dict[str, CommandInfo]:
    ...
    return {
        ...
        'run': CommandInfo(
            ...
            syntax='/run <command>',
            examples=['/run ls -la', '/run cat /etc/nginx/nginx.conf', '/run systemctl status nginx'],
            category='tools',
        ),
        ...
        'pick': CommandInfo(
            ...
            examples=['/pick yes no', '/pick deploy wait rollback', '/pick staging production'],
            category='utilities',
        ),
        'note': CommandInfo(
            name='/note',
        ...
        'explain': CommandInfo(
            ...
            examples=['/explain Docker', '/explain how does SSH work', 'what is kubernetes'],
            category='utilities',
            aliases=['ask'],
        ),
        'imagegen': CommandInfo(
            ...
            examples=['/imagegen a kraken managing servers', '/imagegen cyberpunk data center'],
            category='utilities',
        ),
        'music': CommandInfo(
            name='/music',
        ...
        'video': CommandInfo(
            ...
            syntax='/video <URL>',
            examples=['/video https://youtube.com/watch?v=...', '/download https://tiktok.com/...'],
            category='utilities',
            aliases=['download'],
        ),
