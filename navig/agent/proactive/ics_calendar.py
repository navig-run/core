...
from navig.agent.proactive.providers import CalendarProvider, CalendarEvent
...
class ICSCalendarProvider(CalendarProvider):
    ...
    async def list_events(self, start: datetime, end: datetime) -> List[CalendarEvent]:
        ...
        try:
            ...
            raise ImportError("ICS support requires: pip install icalendar")
    ...
    async def _fetch_ics(self) -> Optional[str]:
        ...
        if self.url:
            try:
                ...
                raise ImportError("Remote ICS requires: pip install httpx")
...
class CalDAVProvider(CalendarProvider):
    ...
    async def list_events(self, start: datetime, end: datetime) -> List[CalendarEvent]:
        ...
        try:
            ...
            raise ImportError("CalDAV support requires: pip install caldav")
    ...
    async def create_event(self, event: CalendarEvent) -> str:
        ...
        try:
            ...
            raise ImportError("CalDAV support requires: pip install caldav icalendar")
