...
class AutoDetection:
    ...
    def collect_performance_metrics(self, remote_ops, server_config: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _calculate_averages(self, metrics_history: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        def avg_for_window(start_time):
            ...
            return {
                ...
                'memory': sum(m.get('memory_percent', 0) for m in window_metrics) / len(window_metrics),
