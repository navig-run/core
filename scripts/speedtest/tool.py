...
def main() -> None:
    ...
    parser.add_argument("--iperf3-server", dest="iperf3_server", default=None,
    ...
    parser.add_argument("--skip-speedtest", dest="skip_speedtest", action="store_true", default=False)
    parser.add_argument("--skip-iperf3",    dest="skip_iperf3",    action="store_true", default=False)
    ...
    if not args.skip_iperf3 and not args.iperf3_server:
        result = err(TOOL, "run", ["--iperf3-server required unless --skip-iperf3 is set"], code=1)
