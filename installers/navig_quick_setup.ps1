...
function Get-NAVIG-Installer {
    ...
    $possiblePaths = @(
        "$PSScriptRoot\install_navig_windows_enhanced.ps1",   # sits next to this script (core/scripts/)
        ".\core\scripts\install_navig_windows_enhanced.ps1"   # when run from the repo root
    )
