...
from navig.memory.indexer import MemoryIndexer, ChunkConfig
from navig.memory.storage import MemoryStorage, MemoryChunk, FileMetadata
...
class TestMemoryBatching(unittest.TestCase):
    ...
    def test_chunking_separation(self):
        ...
        self.indexer._index_file = MagicMock(return_value={'chunks': 1, 'tokens': 100, 'embedded': 0, 'chunks_obj': [MagicMock(content="text")]})
