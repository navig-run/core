...
def test_replay_help_exits_nonzero():
...
def test_replay_list_exits_nonzero():
    with patch(_WARN):
...
def test_replay_run_with_session_exits_nonzero():
    with patch(_WARN):
...
def test_agents_help_exits_nonzero():
...
def test_agents_list_exits_nonzero():
    with patch(_WARN):
...
def test_agents_run_with_name_exits_nonzero():
    with patch(_WARN):
...
def test_boot_help_exits_nonzero():
...
def test_boot_show_exits_nonzero():
    with patch(_WARN):
...
def test_boot_run_exits_nonzero():
    with patch(_WARN):
