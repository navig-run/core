...
EXAMPLE_APP_YAML = (
    Path(__file__).parent.parent.parent / "navig" / "browser" / "templates" / "example-app.yaml"
)
GENERIC_YAML = Path(__file__).parent.parent.parent / "navig" / "browser" / "templates" / "generic.yaml"
