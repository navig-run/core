...
class TestHostCloneFix:
    ...
    def test_clone_host_passes_correct_parameters(self, mock_clone, mock_prompt, mock_ask, mock_state):
...
class TestHostTestFix:
    ...
    def test_test_host_passes_host_name_parameter(self, mock_test, mock_prompt, mock_status, mock_state):
...
class TestHostInspectFix:
    ...
    def test_inspect_host_sets_active_host(self, mock_inspect, mock_prompt, mock_status, mock_state):
