...
class TestAgentConfigLoader:
    ...
    def test_agent_with_json(self, tmp_path):
        ...
        from navig.agent_config_loader import load_agent_json, clear_agent_cache
        clear_agent_cache()
    ...
    def test_agent_without_json(self, tmp_path):
        ...
        from navig.agent_config_loader import load_agent_json, get_agent_llm_mode, clear_agent_cache
        clear_agent_cache()
    ...
    def test_get_agent_llm_mode_helper(self, tmp_path):
        ...
        from navig.agent_config_loader import get_agent_llm_mode, clear_agent_cache
        clear_agent_cache()
    ...
    def test_cache(self, tmp_path):
        ...
        from navig.agent_config_loader import load_agent_json, _agent_config_cache, clear_agent_cache
        clear_agent_cache()
