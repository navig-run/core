"""Hermetic unit tests for navig.ui.skills_renderer."""
...
def _patch_skills_dirs(dirs: list[Path]):
    return patch("navig.ui.skills_renderer._get_skills_dirs", return_value=dirs)
...
class TestFindSkillJson:
    def test_finds_direct_json(self, tmp_path):
        from navig.ui.skills_renderer import _find_skill_json
...
class TestFindSkillMd:
    def test_finds_direct_md(self, tmp_path):
        from navig.ui.skills_renderer import _find_skill_md
...
class TestLoadSkillMd:
    def test_loads_content(self, tmp_path):
        from navig.ui.skills_renderer import _load_skill_md
...
class TestRenderSkillsPrompt:
    ...
    def test_mode_json_renders_skill_name(self, tmp_path):
        ...
        with (
            ...
            patch("navig.ui.skills_renderer._load_template", return_value=None),
        ):
