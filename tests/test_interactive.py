...
class TestHostExecutions:
    ...
    def test_execute_host_list(self, mock_config, mock_host_module):
        ...
        from navig.commands.interactive import execute_host_list, MenuState
    ...
    def test_execute_host_switch(self, mock_config, mock_prompt, mock_host_module):
        ...
        from navig.commands.interactive import execute_host_switch, MenuState
...
class TestDatabaseExecutions:
    ...
    @patch('navig.commands.interactive.console')
    @patch('navig.commands.interactive.ConfigManager')
    def test_execute_sql_query_safe(self, mock_config, mock_console, mock_confirm, mock_prompt, mock_db_module):
        """Test execute_sql_query with safe query."""
        from navig.commands.interactive import execute_sql_query, MenuState
    ...
    @patch('navig.commands.interactive.console')
    @patch('navig.commands.interactive.ConfigManager')
    def test_execute_sql_query_destructive_cancelled(self, mock_config, mock_console, mock_confirm, mock_prompt, mock_db_module):
    ...
    def test_execute_db_backup(self, mock_config, mock_console, mock_prompt, mock_db_module):
        ...
        from navig.commands.interactive import execute_db_backup, MenuState
