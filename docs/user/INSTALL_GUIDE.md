...
**Verification:**
```bash
navig --version          # Must print: navig 2.9.1 (or later)
...
Expected output:
```
Checking dist/navig-2.9.1-py3-none-any.whl: PASSED
Checking dist/navig-2.9.1.tar.gz: PASSED
```
...
/tmp/navig-test-env/bin/pip install --index-url https://test.pypi.org/simple/ --extra-index-url https://pypi.org/simple/ navig==2.9.1
/tmp/navig-test-env/bin/navig --version   # Must print 2.9.1
```
